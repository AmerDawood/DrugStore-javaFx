...
import DrugsStore.model.ImageTextCell;
import DrugsStore.model.Customer;
import DrugsStore.model.Product;
import DrugsStore.model.ProductQueries;
...
public class MainController {
    ...
    public void showHelp(ActionEvent event) {
        ...
        alert.getDialogPane().setContentText("Games Store is an e-store" +
                " where a user can buy games digitally and then" +
                " play them from the Games Library. The user can browse " +
                "through the available games clicking each item on the " +
                "list. Then he can add the selected game to the Shopping" +
                " Cart and proceed to Payment. Each game can be purchased" +
                " only once due to its linking with the user's account.");
        alert.getDialogPane().setHeaderText(null);
